...
<?php 
    $statusmodalsql = "SELECT * FROM `order` WHERE `userId`= $userId";
    ...
    while($statusmodalrow = mysqli_fetch_assoc($statusmodalresult)){
        ...
        $pickupTime = $statusmodalrow['pickupTime'];
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="orderStatus<?php echo $orderid; ?>">Thank you for your order!</h5>
                        ...
                        <div class="card-body">
                            ...
                            <article class="card">
                                <div class="card-body row">
                                    <div class="col"> <strong>Estimated Pickup Time:</strong> <br> <?php echo $pickupTime; ?> </div>
                            ...
                            <?php
                                if($status == 0){
                                      echo '<div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Order Placed</span> </div>
                                            ...
                                            <div class="step"> <span class="icon"> <i class="fa fa-truck"></i> </span> <span class="text"> Your order is ready for pickup! </span> </div>';
                                }
                                elseif($status == 1){
                                    echo '<div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Order Placed</span> </div>
                                ...
                                elseif($status == 3){
                                    echo '<div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Order Placed</span> </div>
                                          <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Order Confirmed</span> </div>
                                          <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text"> Preparing your Order</span> </div>
                                          <div class="step active"> <span class="icon"> <i class="fa fa-truck"></i> </span> <span class="text"> Your order is ready for pickup! </span> </div>';
                                }
                                else {
                            ...
                            <a href="inquiry.php" class="btn btn-warning" data-abc="true">Help <i class="fa fa-chevron-right"></i></a>
                        </div>
                    </article>
                </div>
            </div>
