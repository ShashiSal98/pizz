...
echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <a class="navbar-brand" href="index.php"> WPS Pizzeria</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            while($row = mysqli_fetch_assoc($result)){
              echo '<a class="dropdown-item" href="viewPizzaList.php?catid=' .$row['category_id']. '">' .$row['category_name']. '</a>';
            }
            echo '</div>
          </li>
          <li class="nav-item">
        ...
        $countsql = "SELECT SUM(`itemQuantity`) FROM `shoppingcart` WHERE `userId`=$userId"; 
