                ...
                <div class="row">
                  <div class="col-lg-8">
                    <div class="contact-box p-4">
                      <div class="row">
                        <div class="col-lg-10">
                          <h4 class="title">Feedback Form </h4>Please help us to serve you better by taking a couple of minutes.
                      ...
                      ?>
                      <form action="partials/_manageFeedback.php" method="POST">
                        <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mt-3">
                                <b><label for="email">How satisfied were you with our Service?</label></b>
				 ...
				 <li><input type="radio" name="view" value="poor" id="poor"> 
				      ...
				      <div class="check w3_agileits"></div>
                          ...
                          <div class="col-lg-12">
                            <div class="form-group  mt-3">If you have specific feedback, please write to us...
                                <textarea class="form-control" id="message" name="message" rows="2" required minlength="6" placeholder="Additional comments"></textarea>
                            </div>
                          </div>
                          <?php if($loggedin){ ?>
                            <div class="col-lg-12">
                              <button type="submit" class="btn btn-danger-gradiant mt-3 mb-3 text-white border-0 py-2 px-3"><span> SUBMIT FEEDBACK <i class="ti-arrow-right"></i></span></button>
                  ...
                  <div class="col-lg-4 bg-image" style="background-image:url(img/contact.jpg)">
                          <div class="detail-box p-4">
                            ...
                            <p class="text-white op-7"> No.461 Sherwood Street, <br>  Colombo 04, <br>  Sri Lanka. </p>
                            <h5 class="text-white font-weight-light mb-3 mt-4">CALL US</h5>
                            <p class="text-white op-7">0771234567
                              <br> 0711234567 </p>
                            <div class="round-social light">
                              <a href="https://mail.google.com" class="ml-0 text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="far fa-envelope"></i></a>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" id="messagebd">
              <table class="table-striped table-bordered col-md-12 text-center">
                ...
                <tbody>
                <?php 
                    $sql = "SELECT * FROM `inquiryreply` WHERE `userId`='$userId'"; 
